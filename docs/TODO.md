...
- [ ] Add the anchor's TRY on/off ramp (SEP-6 + SEP-10). It has no SEP-24 and no SEP-45, so only a recovery-phrase account can authenticate to it; the smart wallet cannot.
