...
const TR: Record<string, string> = {
  ...
  'NFC is unavailable right now; use the QR code': 'NFC şu anda kullanılamıyor; QR kodunu kullanın',
  'Preparing NFC': 'NFC hazırlanıyor',
  'Retry NFC': 'NFC’yi yeniden dene',
  'Or let the customer hold their phone here': 'Ya da müşteri telefonunu buraya yaklaştırsın',
  'Bluetooth is unavailable right now; use the QR code': 'Bluetooth şu anda kullanılamıyor; QR kodunu kullanın',
  'Preparing Bluetooth': 'Bluetooth hazırlanıyor',
  'Retry Bluetooth': 'Bluetooth’u yeniden dene',
  'Allow Bluetooth so a customer can pay by holding their phone here': 'Müşterinin telefonunu yaklaştırarak ödeyebilmesi için Bluetooth’a izin verin',
