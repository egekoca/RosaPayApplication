...
const USED = [
  ...
  'Transaction',
  'Close',
  'Rosa Pay finds the merchant you are standing at, and nothing else.',
  'Or let the customer hold their phone against this one',
  'Allow Bluetooth',
  'OVERVIEW',
  'PAYMENT CHANNELS',
  'Money deposited',
