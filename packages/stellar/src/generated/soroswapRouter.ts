// Generated by Stellar CLI 27.1.0 from the deployed Soroswap router,
// CCJUD55AG6W5HAI5LRVNKAE5WDP5XGZBUDS5WNTIVDU7O264UZZE7BRD on Testnet.
//
// Only `router_get_amounts_in` is called from here, to price a payment before
// the customer is asked to approve it. The swap itself is a sub-invocation the
// settlement contract makes, so it is never built on this side.
